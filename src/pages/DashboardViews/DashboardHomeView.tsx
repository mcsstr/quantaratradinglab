      ...
      <div className="w-full flex-1 min-h-[150px] overflow-hidden">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 5, right: 10, left: -20, bottom: 5 }}>
            ...
            <YAxis domain={[settings.initialBalance - 500, 'auto']} stroke={theme.textoSecundario} fontSize={10} tickFormatter={(value) => new Intl.NumberFormat(userLocale, { style: 'currency', currency: settings.brokerCurrency, currencyDisplay: 'narrowSymbol', maximumFractionDigits: 0 }).format(value)} axisLine={false} tickLine={false} />
      ...
      {settings.dashboardLayout === 'layout1' ? (
        <div className="space-y-4 mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="h-[300px] md:h-[350px]">{tradesByDayBlock}</div>
            <div className="h-[300px] md:h-[350px]">{pnlByDayBlock}</div>
          </div>
          {calendarBlock}
        </div>
      ) : (
